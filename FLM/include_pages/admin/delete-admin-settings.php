...
<?php 
$get_login_names="select * from login where admin=1";
...
//print_r($arr);
 ...
 ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Delete Admin</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <form class="form-horizontal" role="form" method="post" action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<div class="form-group">
      ...
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" class="btn btn-primary" value="Submit" name="submit_admin_settings">
...
if( isset($_POST['submit_admin_settings']) )
	...
	if( !empty($_POST['drop_admin_settings'] )) 
	{
		...
		$add_admin="UPDATE login set admin=0 where username='$login_name'";
		$res=mysqli_query($connection,$add_admin);
		echo  '<div class="alert alert-success alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                '.$login_name.' is deleted from admin panel.
                            </div>';
	}
	else
	{
