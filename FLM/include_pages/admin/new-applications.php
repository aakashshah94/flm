...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">New Applications</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
while( $row=mysqli_fetch_array($result) )
{
	...
	$remarks="";
		...
		echo '<td>'.'<form method="post" action="../../include/update.php" >
					...
					<input type="submit" class="btn btn-success" name="submit_approve" onclick="myFunction()" id="'. $row['id'].'" value="Approve"></td><td>
					
					<input type="submit" class="btn btn-danger" name="submit_disapprove" onclick="myFunction()" id="'. $row['id'].'" value="DIsapprove">
