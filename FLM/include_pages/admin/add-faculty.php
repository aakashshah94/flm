...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   <div class="form-group">
	...
	<div class="form-group">
      <label class="control-label col-lg-2" for="name">Password</label>
      <div class="col-lg-10">
	  <!--<p class="form-control-static"></p>-->
        <input type="password" class="form-control"  placeholder="password" name="password_new" value="<?php echo $password_new;?>">
		
		 <span class="error">*<?php echo $passwordErr_new;?></span>
      </div>
    </div>
	<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" class="btn btn-success" value="Submit" onclick="myFunction()" name="submit_new">
...
if( isset($_POST['submit_new']) )
{
	...
	if( empty($nameErr_new) && empty($passwordErr_new) && empty($emp_idErr_new) &&  !empty($name_new) &&  !empty($password_new) && !empty($emp_id_new) ) 
	{
		...
		if($num=='0' && $num2=='0')
		{
			...
			$sqladd2="INSERT INTO demo_init (Emp_id,Name) VALUES ('$_POST[emp_id_new]','$_POST[name_new]')";
			$res_sqladd2=mysqli_query($connection,$sqladd2);
			$sqladd3="INSERT INTO demo (emp_id,Name) VALUES ('$_POST[emp_id_new]','$_POST[name_new]')";
